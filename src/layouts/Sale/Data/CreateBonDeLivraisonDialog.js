...
const CreateBonDeLivraisonDialog = ({ open, handleClose }) => {
  ...
  const handleConfirmApprove = () => {
    console.log("Bon de livraison approved");
  ...
  return (
    <Dialog open={open} onClose={handleClose} maxWidth="xl" fullWidth>
      <DialogTitle style={styles.dialogTitle}>Nouveau Bon de Livraison</DialogTitle>
      ...
      {showConfirmOverlay && (
        <div style={styles.overlay}>
          <div style={styles.overlayContent}>
            <Typography variant="h6">Confirmer l'approbation</Typography>
...
CreateBonDeLivraisonDialog.propTypes = {
  open: PropTypes.bool.isRequired,
  handleClose: PropTypes.func.isRequired,
};

export default CreateBonDeLivraisonDialog;
