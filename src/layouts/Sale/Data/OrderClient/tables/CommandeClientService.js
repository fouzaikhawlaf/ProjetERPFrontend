                        ...
                        >
                          ...
                          >
                            ...
                            <Tooltip title="Copier JSON de la ligne">
                              <IconButton
                                size="small"
                                onClick={() => copyToClipboard(commande)}
                              >
                      ...
                      >
                        <Box sx={{ textAlign: "center" }}>
                          ...
                          <Typography variant="body2" sx={{ mt: 1 }}>
                            {commandes.length === 0
                              ? "Aucune commande client n'a été créée. Créez une nouvelle commande."
