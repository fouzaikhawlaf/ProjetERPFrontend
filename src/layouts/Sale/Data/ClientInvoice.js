...
const ClientInvoices = () => {
  ...
  const invoices = [
    { id: 201, client: 'Client A', status: 'Paid', date: '2023-08-01', total: '$1,500' },
    { id: 202, client: 'Client B', status: 'Pending', date: '2023-08-10', total: '$2,300' },
    { id: 203, client: 'Client C', status: 'Unpaid', date: '2023-08-15', total: '$1,800' },
    ...
    <DashboardLayout>
      ...
      <Container fluid className="my-4" style={{ background: 'linear-gradient(135deg, #f9f9f9, #e3f2fd)', padding: '40px', borderRadius: '10px' }}>
        ...
        <Row className="mb-4 align-items-center">
          <Col md={6}>
            <h2 className="fw-bold" style={{ color: '#2c3e50', fontSize: '28px' }}>Invoices</h2>
